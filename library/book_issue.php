      ...
      <div class="container">
        ...
        <?php
          if(isset($_GET['msg']))
          {
            ...
            echo "alert('Book issued Successfully. Issue No :".$count." ');";
            echo "</script>";
            }
            else if($_GET['msg']==2)
            {
              echo "<script language='javascript' type='text/javascript'>";
            echo "alert('Book issued ! Not available!! ');";
            echo "</script>";
            }
            else
            {
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-10" id="main_body">
                <form class="form" action="issue_items.php" method="POST">
                <br><br>
                      <label class="text-white">Book No</label><br><br>
                      <input type="text" name='book_no' class="form-control"  required><br>
                      <label class="text-white">Student Roll No</label><br><br>
                      <input type="text" class="form-control" name='student_roll' required><br>    
                      <label class="text-white">Student Name</label><br><br>
                      <input type="text" class="form-control" name='student_name' required><br>
                      <label class="text-white">Date of Issue</label><br><br>
                      <input type="date" class="form-control" name='date_of_issue' required><br><br>
                      <label class="text-white">Last Date of Submission</label><br><br>
                      <input type="date" class="form-control" name='last_date_of_submission' required><br><br>
